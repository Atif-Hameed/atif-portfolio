    ...
    <footer className="bg-gray-900 pt-12 pb-7">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-white text-lg mb-4">Technologies</h4>
            <ul className="space-y-2">
              {["Frontend", "Backend", "Mobile", "Cloud", "DevOps", "AI/ML"].map(
                (tech) => (
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-white text-lg mb-4">Connect</h4>
